...
class Curriculo(models.Model):
    apresentacao_curriculo = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(5)], blank=False)
    apresentacao_pessoal = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(5)], blank=False)
    ...
    relato_experiencia =  models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(5)], blank=False)
    relato_desligamento =  models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(5)], blank=False)
    observacao_experiencia = models.CharField(max_length=500, blank=False)
    relato_motivacao =  models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(5)], blank=False)
    ...
    relato_interesse =  models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(5)], blank=False)
    relato_equipe =  models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(5)], blank=False)
